            ...
            <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data" id="editProductForm">
                ...
                <div class="mb-3">
                    ...
                    <div class="position-relative">
                        ...
                        <input type="text" name="location" id="locationInput" value="{{ old('location', $product->location) }}"
            ...
            fetch(`/api/location-suggest?q=${encodeURIComponent(q)}`)
                ...
                .then(items => {
                    ...
                    items.forEach(item => {
                        ...
                        li.addEventListener('mousedown', () => { input.value = item.label; list.style.display = 'none'; });
                        list.appendChild(li);
                    });
